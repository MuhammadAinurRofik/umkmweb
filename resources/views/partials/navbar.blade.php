<nav class="bg-transparent backdrop-brightness-90 backdrop-blur-lg absolute top-0 left-0 w-full text-white z-10">
    <div class="container mx-auto flex justify-between items-center py-4 px-4">
        <a href="/" class="text-2xl font-bold">LILBABY</a>
